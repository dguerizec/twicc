...
- `--model VALUE` — Claude Code: `fable`, `opus`, `sonnet`, `opus-4.8`, `opus-4.7`, `opus-4.6`, `opus-4.5`, `sonnet-4.6`, `sonnet-4.5`. Codex: `gpt-sol`, `gpt-terra`, `gpt-luna`, `gpt`, `gpt-mini`, `gpt-5.4`.
