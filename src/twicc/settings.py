...
CODEX_COMPUTE_VERSION = 41  # 41: code-mode write_stdin wrappers rebind to their exec_command (40: screenshot-tag substitution resolves real images from tool-result outputs, 39: mcp end pairing normalises server/tool like the JS identifier, 38: code-mode nested mcp_tool_call_end paired to its exec)
